...
func BenchmarkBatchInsert2000(b *testing.B)  { benchmarkBatchInsert(b, 2000, false) }
func BenchmarkBatchInsert3000(b *testing.B)  { benchmarkBatchInsert(b, 3000, false) }
func BenchmarkBatchInsert4000(b *testing.B)  { benchmarkBatchInsert(b, 4000, false) }
func BenchmarkBatchInsert5000(b *testing.B)  { benchmarkBatchInsert(b, 5000, false) }
func BenchmarkBatchInsert6000(b *testing.B)  { benchmarkBatchInsert(b, 6000, false) }
func BenchmarkBatchInsert7000(b *testing.B)  { benchmarkBatchInsert(b, 7000, false) }
func BenchmarkBatchInsert8000(b *testing.B)  { benchmarkBatchInsert(b, 8000, false) }
func BenchmarkBatchInsert9000(b *testing.B)  { benchmarkBatchInsert(b, 9000, false) }
...
// func BenchmarkOverDraftNotFull0(b *testing.B)  { 
// 	pool, _ := setupPool()
// 	defer pool.Stop()
...
// 		for j := 0; j < 300; j++{
// 			overDraftTxs[j] = pricedValuedTransaction(uint64(0), 1100000000000000000, 21000, big.NewInt(20000), key)
// 		}
...
// func BenchmarkOverDraftNotFull2(b *testing.B)   { benchmarkOverDraftNotFull(b, 2) }
// func BenchmarkOverDraftNotFull3(b *testing.B)   { benchmarkOverDraftNotFull(b, 3) }
// func BenchmarkOverDraftNotFull4(b *testing.B)   { benchmarkOverDraftNotFull(b, 4) }
// func BenchmarkOverDraftNotFull5(b *testing.B)   { benchmarkOverDraftNotFull(b, 5) }
// func BenchmarkOverDraftNotFull6(b *testing.B)   { benchmarkOverDraftNotFull(b, 6) }
// func BenchmarkOverDraftNotFull7(b *testing.B)   { benchmarkOverDraftNotFull(b, 7) }
// func BenchmarkOverDraftNotFull8(b *testing.B)   { benchmarkOverDraftNotFull(b, 8) }
// func BenchmarkOverDraftNotFull9(b *testing.B)   { benchmarkOverDraftNotFull(b, 9) }
...
// func BenchmarkNormalNotFull0(b *testing.B) {
// 	// Generate a batch of overdraft transactions to add in the pool
// 	pool, _ := setupPool()
// 	defer pool.Stop()
...
// 		for j := 0; j < 300; j++{
// 			NormalTxs[j] = pricedValuedTransaction(uint64(j), 10000, 21000, big.NewInt(20000), key)
// 		}
// 		pool.AddRemotes(NormalTxs)	
// 	}
// }
// func BenchmarkNormalNotFull1(b *testing.B)   { benchmarkNormalNotFull(b, 1) }
// func BenchmarkNormalNotFull2(b *testing.B)   { benchmarkNormalNotFull(b, 2) }
// func BenchmarkNormalNotFull3(b *testing.B)   { benchmarkNormalNotFull(b, 3) }
// func BenchmarkNormalNotFull4(b *testing.B)   { benchmarkNormalNotFull(b, 4) }
// func BenchmarkNormalNotFull5(b *testing.B)   { benchmarkNormalNotFull(b, 5) }
// func BenchmarkNormalNotFull6(b *testing.B)   { benchmarkNormalNotFull(b, 6) }
// func BenchmarkNormalNotFull7(b *testing.B)   { benchmarkNormalNotFull(b, 7) }
// func BenchmarkNormalNotFull8(b *testing.B)   { benchmarkNormalNotFull(b, 8) }
// func BenchmarkNormalNotFull9(b *testing.B)   { benchmarkNormalNotFull(b, 9) }
...
// 		NormalTxs := make(types.Transactions, 300)
// 		for j := 0; j < 300; j++{
// 			NormalTxs[j] = pricedValuedTransaction(uint64(size+j), 10000, 21000, big.NewInt(20000), key)
// 		}
// 		pool.AddRemotes(NormalTxs)	
// 	}
// }
...
// func BenchmarkOverDraftFull0(b *testing.B) {
// 	// Generate a batch of overdraft transactions to add in the pool
// 	pool, _ := setupPool()
// 	defer pool.Stop()
...
// 	// Send 5120 valid txs with low gasprice from Cindy
// 	NormalTxs := make(types.Transactions, int(pool.config.GlobalSlots))
...
// 		NormalTxs[j] = pricedValuedTransaction(uint64(j), int64(100000000000000000/int(pool.config.GlobalSlots)), 21000, big.NewInt(300), key_Cindy)
// 	}
// 	pool.AddRemotes(NormalTxs)
...
// 		overDraftTxs := make(types.Transactions, 300)
// 		for j := 0; j < 300; j++{
// 			overDraftTxs[j] = pricedValuedTransaction(uint64(0), 1100000000000000000, 21000, big.NewInt(20000), key_Bob)
// 		}
// 		pool.AddRemotes(overDraftTxs)
// 	}
// }
...
// func BenchmarkOverDraftFull2(b *testing.B)   { benchmarkOverDraftFull(b, 2) }
// func BenchmarkOverDraftFull3(b *testing.B)   { benchmarkOverDraftFull(b, 3) }
// func BenchmarkOverDraftFull4(b *testing.B)   { benchmarkOverDraftFull(b, 4) }
// func BenchmarkOverDraftFull5(b *testing.B)   { benchmarkOverDraftFull(b, 5) }
// func BenchmarkOverDraftFull6(b *testing.B)   { benchmarkOverDraftFull(b, 6) }
// func BenchmarkOverDraftFull7(b *testing.B)   { benchmarkOverDraftFull(b, 7) }
// func BenchmarkOverDraftFull8(b *testing.B)   { benchmarkOverDraftFull(b, 8) }
// func BenchmarkOverDraftFull9(b *testing.B)   { benchmarkOverDraftFull(b, 9) }
...
// func BenchmarkNormalFull0(b *testing.B) {
// 	// Generate a batch of overdraft transactions to add in the pool
// 	pool, _ := setupPool()
// 	defer pool.Stop()
...
// 		NormalTxs := make(types.Transactions, 300)
// 		for j := 0; j < 300; j++{
// 			NormalTxs[j] = pricedValuedTransaction(uint64(j), 10000, 21000, big.NewInt(20000), key_Bob)
// 		}
// 		pool.AddRemotes(NormalTxs)	
// 	}
// }
...
// func BenchmarkNormalFull2(b *testing.B)   { benchmarkNormalFull(b, 2) }
// func BenchmarkNormalFull3(b *testing.B)   { benchmarkNormalFull(b, 3) }
// func BenchmarkNormalFull4(b *testing.B)   { benchmarkNormalFull(b, 4) }
// func BenchmarkNormalFull5(b *testing.B)   { benchmarkNormalFull(b, 5) }
// func BenchmarkNormalFull6(b *testing.B)   { benchmarkNormalFull(b, 6) }
// func BenchmarkNormalFull7(b *testing.B)   { benchmarkNormalFull(b, 7) }
// func BenchmarkNormalFull8(b *testing.B)   { benchmarkNormalFull(b, 8) }
// func BenchmarkNormalFull9(b *testing.B)   { benchmarkNormalFull(b, 9) }
...
// 		NormalTxs := make(types.Transactions, 300)
// 		for j := 0; j < 300; j++{
// 			NormalTxs[j] = pricedValuedTransaction(uint64(size+j), 10000, 21000, big.NewInt(20000), key_Bob)
// 		}
// 		pool.AddRemotes(NormalTxs)	
// 	}
// }
...
// func BenchmarkNotFullED4_1(b *testing.B)   { benchmarkNotFullED4(b, 1) }
// func BenchmarkNotFullED4_2(b *testing.B)   { benchmarkNotFullED4(b, 2) }
// func BenchmarkNotFullED4_3(b *testing.B)   { benchmarkNotFullED4(b, 3) }
// func BenchmarkNotFullED4_4(b *testing.B)   { benchmarkNotFullED4(b, 4) }
// func BenchmarkNotFullED4_5(b *testing.B)   { benchmarkNotFullED4(b, 5) }
// func BenchmarkNotFullED4_6(b *testing.B)   { benchmarkNotFullED4(b, 6) }
// func BenchmarkNotFullED4_7(b *testing.B)   { benchmarkNotFullED4(b, 7) }
// func BenchmarkNotFullED4_8(b *testing.B)   { benchmarkNotFullED4(b, 8) }
// func BenchmarkNotFullED4_9(b *testing.B)   { benchmarkNotFullED4(b, 9) }
// func BenchmarkNotFullED4_10(b *testing.B)   { benchmarkNotFullED4(b, 10) }
// func BenchmarkNotFullED4_100(b *testing.B)   { benchmarkNotFullED4(b, 100) }
// func BenchmarkNotFullED4_1000(b *testing.B)   { benchmarkNotFullED4(b, 1000) }
// func BenchmarkNotFullED4_2000(b *testing.B)   { benchmarkNotFullED4(b, 2000) }
// func BenchmarkNotFullED4_3000(b *testing.B)   { benchmarkNotFullED4(b, 3000) }
// func BenchmarkNotFullED4_4000(b *testing.B)   { benchmarkNotFullED4(b, 4000) }

// func benchmarkNotFullED4(b *testing.B, nonce_index int) {
// 	// Generate a batch of overdraft transactions to add in the pool
// 	pool, _ := setupPool()
// 	defer pool.Stop()
...
// 	// Send 4000 valid txs with high gasprice from Bob.
// 	batch := make(types.Transactions, 4000)
// 	for i := 0; i < 4000; i++ {
// 		// PriceSet := big.NewInt(100000000000000000)
// 		batch[i] = pricedValuedTransaction(uint64(i), int64(100000000000000000/4000), 21000, big.NewInt(20000), key_Bob)
// 	}
// 	pool.AddRemotes(batch)


// 	b.ReportAllocs()
// 	// Benchmark the speed of pool check replaced overdraft txs
// 	b.ResetTimer()
// 	for i := 0; i < b.N; i++ {
// 		overDraftTxs := make(types.Transactions, 300)
// 		for j := 0; j < 300; j++{
// 			overDraftTxs[j] = pricedValuedTransaction(uint64(nonce_index-1), 910000000000000000, 21000, big.NewInt(20000), key_Bob)
// 		}
// 		pool.AddRemotes(overDraftTxs)
// 	}
// }

// func BenchmarkNotFullNormalED4_1(b *testing.B)   { benchmarkNotFullNormalED4(b, 1) }
// func BenchmarkNotFullNormalED4_2(b *testing.B)   { benchmarkNotFullNormalED4(b, 2) }
// func BenchmarkNotFullNormalED4_3(b *testing.B)   { benchmarkNotFullNormalED4(b, 3) }
// func BenchmarkNotFullNormalED4_4(b *testing.B)   { benchmarkNotFullNormalED4(b, 4) }
// func BenchmarkNotFullNormalED4_5(b *testing.B)   { benchmarkNotFullNormalED4(b, 5) }
// func BenchmarkNotFullNormalED4_6(b *testing.B)   { benchmarkNotFullNormalED4(b, 6) }
// func BenchmarkNotFullNormalED4_7(b *testing.B)   { benchmarkNotFullNormalED4(b, 7) }
// func BenchmarkNotFullNormalED4_8(b *testing.B)   { benchmarkNotFullNormalED4(b, 8) }
// func BenchmarkNotFullNormalED4_9(b *testing.B)   { benchmarkNotFullNormalED4(b, 9) }
// func BenchmarkNotFullNormalED4_10(b *testing.B)   { benchmarkNotFullNormalED4(b, 10) }
// func BenchmarkNotFullNormalED4_100(b *testing.B)   { benchmarkNotFullNormalED4(b, 100) }
// func BenchmarkNotFullNormalED4_1000(b *testing.B)   { benchmarkNotFullNormalED4(b, 1000) }
// func BenchmarkNotFullNormalED4_2000(b *testing.B)   { benchmarkNotFullNormalED4(b, 2000) }
// func BenchmarkNotFullNormalED4_3000(b *testing.B)   { benchmarkNotFullNormalED4(b, 3000) }
// func BenchmarkNotFullNormalED4_4000(b *testing.B)   { benchmarkNotFullNormalED4(b, 4000) }

// func benchmarkNotFullNormalED4(b *testing.B, nonce_index int) {
// 	// Generate a batch of overdraft transactions to add in the pool
// 	pool, _ := setupPool()
// 	defer pool.Stop()
...
// 	for i := 0; i < 4000; i++ {
// 		// PriceSet := big.NewInt(100000000000000000)
// 		batch[i] = pricedValuedTransaction(uint64(i), 10000, 21000, big.NewInt(20000), key_Bob)
// 	}
// 	pool.AddRemotes(batch)
...
// 		NormalTxs := make(types.Transactions, 300)
// 		for j := 0; j < 300; j++{
// 			NormalTxs[j] = pricedValuedTransaction(uint64(nonce_index-1), 100000, 21000, big.NewInt(20000), key_Bob)
// 		}
// 		pool.AddRemotes(NormalTxs)
// 	}
// }
...
func BenchmarkTD1_1(b *testing.B)   { benchmarkTD1(b, 1) }
func BenchmarkTD1_2(b *testing.B)   { benchmarkTD1(b, 2) }
func BenchmarkTD1_3(b *testing.B)   { benchmarkTD1(b, 3) }
func BenchmarkTD1_4(b *testing.B)   { benchmarkTD1(b, 4) }
func BenchmarkTD1_5(b *testing.B)   { benchmarkTD1(b, 5) }
func BenchmarkTD1_6(b *testing.B)   { benchmarkTD1(b, 6) }
func BenchmarkTD1_7(b *testing.B)   { benchmarkTD1(b, 7) }
func BenchmarkTD1_8(b *testing.B)   { benchmarkTD1(b, 8) }
func BenchmarkTD1_9(b *testing.B)   { benchmarkTD1(b, 9) }
func BenchmarkTD1_10(b *testing.B)   { benchmarkTD1(b, 10) }
func BenchmarkTD1_100(b *testing.B)   { benchmarkTD1(b, 100) }
func BenchmarkTD1_1000(b *testing.B)   { benchmarkTD1(b, 1000) }
func BenchmarkTD1_2000(b *testing.B)   { benchmarkTD1(b, 2000) }
func BenchmarkTD1_3000(b *testing.B)   { benchmarkTD1(b, 3000) }
func BenchmarkTD1_4000(b *testing.B)   { benchmarkTD1(b, 4000) }

func benchmarkTD1(b *testing.B, size int) {
	// Generate TD1 transactions add in txpool.
	pool, _ := setupPool()
	defer pool.Stop()
	...
	// Send n+1 valid txs:
	// first tx which is the tx with nonce 1 in account list set up with low gasprice say 1000
	// The children tx set up with high gasprice say 200000 from Bob.
	batch := make(types.Transactions, size+1)
	batch[0] = pricedValuedTransaction(uint64(0), 1000000, 21000, big.NewInt(1000), key_Bob)
	for i := 0; i < size; i++ {
		// PriceSet := big.NewInt(100000000000000000)
		// batch[i+1] = transaction(uint64(i+1), 1000000, key_Bob)
		batch[i+1] = pricedValuedTransaction(uint64(i+1), 1000000, 21000, big.NewInt(200000), key_Bob)
	}
	pool.AddRemotes(batch)

	// Send 4096-n-1 valid txs with high gasprice from Cindy
	NormalTxs := make(types.Transactions, int(pool.config.GlobalSlots)-size-1)
	key_Cindy, _ := crypto.GenerateKey()
	account_Cindy := crypto.PubkeyToAddress(key_Cindy.PublicKey)
	testAddBalance(pool, account_Cindy, big.NewInt(1000000000000000000))
	for j := 0; j < int(pool.config.GlobalSlots)-size-1; j++ {
		NormalTxs[j] = pricedValuedTransaction(uint64(j), 1000000, 21000, big.NewInt(200000), key_Cindy)
	}
	pool.AddRemotes(NormalTxs)
	...
	for i := 0; i < 16; i++ {
		...
		testAddBalance(pool, account_Alice, big.NewInt(1000000000000000000))
		for j := 0; j < int(pool.config.AccountQueue); j++ {
			futureTxs[j] = pricedValuedTransaction(uint64(j+100), 1000000, 21000, big.NewInt(200000), key_Alice)
		}
		pool.AddRemotes(futureTxs)
	}

	key_David, _ := crypto.GenerateKey()
	account_David := crypto.PubkeyToAddress(key_David.PublicKey)
	testAddBalance(pool, account_David, big.NewInt(1000000000000000000))

	b.ReportAllocs()
	b.ResetTimer()

	for i := 0; i < b.N; i++ {
		TD_Tx := pricedValuedTransaction(uint64(0), 1000000, 21000, big.NewInt(20000), key_David)
		pool.AddRemote(TD_Tx)
	}
...
// 	testAddBalance(pool, account_David, big.NewInt(1000000000000000000))
// 	for i := 0; i < b.N; i++ {
// 		TD_Tx := pricedValuedTransaction(uint64(0), 1000000, 21000, big.NewInt(300000), key_David)
// 		pool.AddRemote(TD_Tx)
// 	}
...
// func BenchmarkTD1_9(b *testing.B)   { benchmarkTD1(b, 9) }
// func BenchmarkTD1_10(b *testing.B)   { benchmarkTD1(b, 10) }
// func BenchmarkTD1_20(b *testing.B)   { benchmarkTD1(b, 20) }
// func BenchmarkTD1_30(b *testing.B)   { benchmarkTD1(b, 30) }
// func BenchmarkTD1_40(b *testing.B)   { benchmarkTD1(b, 40) }
// func BenchmarkTD1_50(b *testing.B)   { benchmarkTD1(b, 50) }
// func BenchmarkTD1_60(b *testing.B)   { benchmarkTD1(b, 60) }
// func BenchmarkTD1_70(b *testing.B)   { benchmarkTD1(b, 70) }
// func BenchmarkTD1_80(b *testing.B)   { benchmarkTD1(b, 80) }
// func BenchmarkTD1_90(b *testing.B)   { benchmarkTD1(b, 90) }
// func BenchmarkTD1_100(b *testing.B)   { benchmarkTD1(b, 100) }
// func BenchmarkTD1_200(b *testing.B)   { benchmarkTD1(b, 200) }
// func BenchmarkTD1_300(b *testing.B)   { benchmarkTD1(b, 300) }
...
// 	// first tx which is the tx with nonce 1 in account list set up with low gasprice say 1000
// 	// The children tx set up with high gasprice say 200000 from Bob.
// 	batch := make(types.Transactions, 301)
// 	batch[0] = pricedValuedTransaction(uint64(0), 1000000, 21000, big.NewInt(1000), key_Bob)
// 	for i := 0; i < 300; i++ {
// 		// PriceSet := big.NewInt(100000000000000000)
// 		// batch[i+1] = transaction(uint64(i+1), 1000000, key_Bob)
